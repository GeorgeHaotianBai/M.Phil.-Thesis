...
\begin{figure}[H]
    ...
    \subfigure[\bf Majority mobilization peaks at $S_k=\overline{S}(E_m)$.]{%
        \includegraphics[width=0.48\textwidth]{figures/functions/fig_Sk_statics_mobilization.pdf}%
        \label{fig:Sk_statics_mobilization}%
    }\hfill
    \subfigure[\bf Effective enforcement $Z_k^*$ keeps rising beyond the mobilization peak.]{%
        \includegraphics[width=0.48\textwidth]{figures/functions/fig_Sk_statics_enforcement.pdf}%
